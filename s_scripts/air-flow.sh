...
# Airflow Triggerer
airflow triggerer -l=/root/logs/airflow/triggerer/triggerer.log --stderr=/root/logs/airflow/triggerer/triggerer.err --stdout=/root/logs/airflow/triggerer/triggerer.out --pid=/run/airflow/airflow-triggerer.pid -D

# Airflow Triggerer
airflow dag-processor -l=/root/logs/airflow/dag_processor_manager/dag_processor_manager.log --stderr=/root/logs/airflow/dag_processor_manager/dag_processor_manager.err --stdout=/root/logs/airflow/dag_processor_manager/dag_processor_manager.out --pid=/run/airflow/airflow-dagprocessor.pid -D
