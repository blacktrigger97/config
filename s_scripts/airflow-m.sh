...
# Airflow Flower
airflow celery flower --hostname `hostname` -l=/root/airflow/logs/flower/flower.log --stderr=/root/airflow/logs/flower/flower.err --stdout=/root/airflow/logs/flower/flower.out --pid=/run/airflow/airflow-flower.pid &
