...
# Airflow Api Server
airflow api-server --host `hostname` & # -l=/opt/airflow/logs/api-server/api-server.log --stderr=/opt/airflow/logs/api-server/api-server.err --stdout=/opt/airflow/logs/api-server/api-server.out --pid=/run/airflow/airflow-server.pid &
...
# Airflow Triggerer
airflow triggerer --host `hostname` & # -l=/opt/airflow/logs/triggerer/triggerer.log --stderr=/opt/airflow/logs/triggerer/triggerer.err --stdout=/opt/airflow/logs/triggerer/triggerer.out --pid=/run/airflow/airflow-triggerer.pid &
